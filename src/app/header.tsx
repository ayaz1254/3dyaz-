        ...
        <div className="mx-auto max-w-6xl px-6 flex justify-between items-center">
          ...
          {isMagaza ? (
            ...
            <div className="hidden md:flex items-center gap-3 flex-1 justify-end">
              ...
              {/* Admin (yalnızca admin kullanıcılar) */}
              {isAdmin && (
                <Link
                  href="/admin"
              ...
              {isMagaza ? (
                <>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-white">Özel Sipariş</span>
                  </Link>
                  <Link
                    href="/siparis-takip"
                    onClick={() => setMobileOpen(false)}
                  ...
                  {isMagaza && (
                    <div className="mt-4 pt-4 border-t border-white/10">
                      <Link
                        href="/"
                        onClick={() => setMobileOpen(false)}
                        className="flex items-center justify-center bg-[#05cc47] text-black font-bold px-5 py-3 rounded-full text-sm"
                      >
                        Ana Sayfa
                      </Link>
                    </div>
